...
wb = ox.load_workbook(filename='peps300.xlsx', use_iterators=True)
ws = wb.active
...
c1.execute("""create table schools (OPEID CHAR(20), NAME CHAR(100), ADDRESS CHAR(100), CITY CHAR(100),
           ...
           YEAR_2 INT(4), NUM_2 INT(10), DENOM_2 INT(10), DRATE_2 DECIMAL(5,2), PRATE_2 CHAR(20),
...
for x in row_iter:
    c1.execute(r'insert into schools (OPEID, NAME, ADDRESS, CITY, STATE, STATE_DESC, ZIP, ZIP_EXT, PROGRAM_LENGTH, SCHOOL_TYPE, YEAR_1, NUM_1, DENOM_1, DRATE_1, PRATE_1, ETHNIC_CODE, CONG_DIS, REGION, AVERAGE_OR_GREATER_THAN_30, YEAR_2, NUM_2, DENOM_2, DRATE_2, PRATE_2, YEAR_3, NUM_3, DENOM_3, DRATE_3, PRATE_3) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',(x))
    count += 1
    print count
conn.commit()
